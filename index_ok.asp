...
<%	
	...
	'## 변수처리 ##
	IP				= page_info(1)
	MaxNumber		= SR_FUN_getMaxFromDB ("tb_childcare", "sn", "")
	state			= "N"

	'-----------쿼리 작성--------------------------------------------------------------
	SQL = "insert into tb_childcare(sn,Name,Tel,Email,Memo,state,ip,regist_day) values ('"
	SQL = SQL &  MaxNumber        	& "','"
	...
	'email = "a3613@nate.com" '관리자 이메일 등록

	Call SendMail("관리자 <recruit@injeinc.co.kr>", email, "CMS 구매문의가 들어왔습니다.", "CMS 구매문의가 들어왔습니다.","")

	
	ftnjsAlertMsgUrl "문의/상담이 신청되었습니다. 확인 후 연락드리겠습니다.","/"
%>
